...
![intro](/Users/churry/Documents/churry75.github.io/assets/images/lecture/week09_imgs/intro.png)
...
![hough_theory](/Users/churry/Documents/churry75.github.io/assets/images/lecture/week09_imgs/hough_theory.jpeg)
...
1. Standard hough transform
    - `cv2.HoughLines(image, rho, theta, threshold)`
        ...
        - threshold: hough space에서 threshold 이상의 직선이 겹치는 교점은 하나의 직선을 형성한다고 판단
            ...
            ![threshold](/Users/churry/Documents/churry75.github.io/assets/images/lecture/week09_imgs/threshold.png)
...
2. Probabilistic hough transform
    - `cv2.HoughLinesP(image, rho, theta, threshold, minLineLenght, maxLineGap)`
        ...
        - maxLineGap: 간격의 최대 길이, 이것보다 작은 간격은 하나의 선분으로 간주
            ...
            ![maxLineGap](/Users/churry/Documents/churry75.github.io/assets/images/lecture/week09_imgs/maxlinegap.png)
    - 검출된 직선의 **(x, y) 좌표쌍**을 반환함
        > (x1, y1, x2, y2) 형태
3. 두 방식의 차이점
    - **HoughLines**는 **직선**을 검출
    - **HoughLinesP**는 **선분**을 검출\
    ![diff](/Users/churry/Documents/churry75.github.io/assets/images/lecture/week09_imgs/diff.png)
...
```
|![test](/Users/churry/Documents/churry75.github.io/assets/images/lecture/week09_imgs/test.png)|![hough_test](/Users/churry/Documents/churry75.github.io/assets/images/lecture/week09_imgs/hough_test.png)|
|:---:|:---:|
